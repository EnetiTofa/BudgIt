...
// Ensure this import points to the file with allTransactionOccurrencesProvider
...
Future<List<BudgetProgress>> budgetProgress(Ref ref, BudgetView budgetView) async {
  ...
  // We now depend on the master list of all transactions, not the filtered UI list.
  ...
  for (final category in categories) {
    ...
    // This logic now correctly uses the full, unfiltered transaction list.
