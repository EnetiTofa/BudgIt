...
class _WalletBarChartState extends ConsumerState<WalletBarChart> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        padding: const EdgeInsets.fromLTRB(16.0, 16.0, 16.0, 24.0), // Restored uniform padding for the card interior
        child: Column(
          children: [
            _WeekSelector(
            ...
            Padding(
              // Adds 8px extra to the right side of the chart (16 outer + 8 inner = 24px total)
