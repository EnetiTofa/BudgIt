...
// FIX 1: Point to the consolidated weekly providers
...
import 'package:budgit/src/features/budget_hub/presentation/widgets/segmented_linear_gauge.dart';
...
// FIX 2: Renamed the class to match the domain model
class WeeklyCategoryDetailScreen extends ConsumerWidget {
  final WeeklyCategoryData data; // Uses the updated domain model

  const WeeklyCategoryDetailScreen({super.key, required this.data});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // 1. Listen to the LIVE data source
    // FIX 3: Use the renamed weeklyDateProvider
    final date = ref.watch(weeklyDateProvider);
    // FIX 4: Use the renamed weeklyCategoryDataProvider
    ...
    return Scaffold(
      appBar: AppBar(title: Text(liveData.category.name)),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 4. Active Transfers (Renamed the component earlier)
              ...
              child: SummaryCardBase(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // FIX 5: Moved valueColor down to the proper argument in the bottom row!
                    _StatRow(
                      value:
