...
class _WalletBarChartState extends ConsumerState<WalletBarChart>
          ...
          children: [
            _WeekSelector(
              ...
              onDateChanged: (newDate) {
                // FIX: Using weeklyDateProvider
                ref.read(weeklyDateProvider.notifier).state = newDate;
              },
            ),
                          ...
                          BarChartData(
                            ...
                            extraLinesData: ExtraLinesData(
                              horizontalLines: [
                                HorizontalLine(
                                  y:
                                      // FIX: Use dailyTarget instead of dailyWalletTarget
                                      chartData.dailyTarget * _animation.value,
