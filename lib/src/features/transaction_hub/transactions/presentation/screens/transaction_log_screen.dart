...
class TransactionLogScreen extends ConsumerWidget {
  ...
  Future<bool> _showDeleteConfirmationDialog({
    ...
    final name = transaction is OneOffPayment
        ? transaction.itemName
        : (transaction as OneOffIncome).source;
                  ...
                  : GroupedListView<Transaction, String>(
                      ...
                      itemBuilder: (context, transaction) {
                        ...
                        if (transaction is OneOffPayment) {
                          ...
                          listTileContent = const ListTile(
                        ...
                        final VoidCallback onTapAction = parentId != null
                            ? () async {
                                ...
                                final parentTx = await repo.getTransactionById(
                                  parentId!,
                                );
